                                ...
                                {profileDropdownOpen && (
                                    ...
                                    >
                                        ...
                                        <Link 
                                            ...
                                            className="px-4 py-3 text-sm text-richblack-5 hover:bg-richblack-700 transition-colors duration-200 flex items-center gap-2"
                                        ...
                                        <button 
                                            className="w-full text-left px-4 py-3 text-sm text-richblack-5 hover:bg-richblack-700 transition-colors duration-200 flex items-center gap-2 border-t border-richblack-600"
